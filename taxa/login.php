...
<body>
	...
	<div class="container-fluid padding light" >
		<div class="col-md-6 col-md-offset-2 ">	
			<h3>If you want to ask questions first login here!!!</h3>
			<form method="post" name="myLogin"  action="askquestion.php">
			...
			<h3>Not a member yet? Create your account here !!!</h3>
			<a href="register.php"><button type="submit" class="btn btn-default" name="submit" >Register</button></a>
		</div>
	</div>
